      ...
      answer: (
        <Text>
          <Trans>
            ...
            step-by-step guide{" "}
            <Link
              href="https://docs.workos/imports/trello"
              className="underline"
            >
              here
            </Link>
      ...
      answer: (
        <Text>
          <Trans>
            ...
            <Link href="https://workos/kan" className="underline">
              workos/kan
            </Link>
            , by going into your{" "}
            <Link href="https://workos/settings" className="underline">
              workspace settings
            </Link>{" "}
      ...
      answer: (
        <Text>
          <Trans>
            ...
            <Link href="https://workos/members" className="underline">
              members page
            </Link>{" "}
      ...
      <div className="flex flex-col items-center justify-center pb-12">
        ...
        <p className="text lg:text-md mt-3 max-w-[500px] text-center text-light-950 dark:text-dark-900">
          <Trans>
            ...
            <Link href="mailto:support@workos" className="underline">
              contact us
            </Link>
            .
          </Trans>
